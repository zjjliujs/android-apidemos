 ...
 *         <tr>
 *             <td >src/io.appium.android.apis/app/AlertDialogSamples.java</td>
    ...
    private void showAlertDialog(int id) {
        ...
        switch (id) {
            case DIALOG_YES_NO_MESSAGE:
                dialog = new AlertDialog.Builder(AlertDialogSamples.this)
            ...
            case DIALOG_YES_NO_OLD_SCHOOL_MESSAGE:
                dialog = new AlertDialog.Builder(AlertDialogSamples.this, AlertDialog.THEME_TRADITIONAL)
                        .setIconAttribute(android.R.attr.alertDialogIcon)
                        .setTitle(R.string.alert_dialog_two_buttons_title)
                        .setPositiveButton(R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
            ...
            case DIALOG_YES_NO_HOLO_LIGHT_MESSAGE:
                dialog = new AlertDialog.Builder(AlertDialogSamples.this, AlertDialog.THEME_HOLO_LIGHT)
                        .setIconAttribute(android.R.attr.alertDialogIcon)
                        .setTitle(R.string.alert_dialog_two_buttons_title)
                        .setPositiveButton(R.string.alert_dialog_ok, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twoButtonsTitle.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_YES_NO_MESSAGE);
            }
        });
        ...
        twoButtons2Title.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_YES_NO_LONG_MESSAGE);
            }
        });
        ...
        twoButtons2UltraTitle.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_YES_NO_ULTRA_LONG_MESSAGE);
            }
        });
        ...
        progressButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_PROGRESS);
                mProgress = 0;
        ...
        radioButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_SINGLE_CHOICE);
            }
        });
        ...
        checkBox.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_MULTIPLE_CHOICE);
            }
        });
        ...
        checkBox2.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_MULTIPLE_CHOICE_CURSOR);
            }
        });
        ...
        textEntry.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_TEXT_ENTRY);
            }
        });
        ...
        twoButtonsOldSchoolTitle.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_YES_NO_OLD_SCHOOL_MESSAGE);
            }
        });
        ...
        twoButtonsHoloLightTitle.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showAlertDialog(DIALOG_YES_NO_HOLO_LIGHT_MESSAGE);
            }
        });
